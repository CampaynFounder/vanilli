...
- Optional: `is_trial` (default `false`), `generation_seconds` (unused in Python but sent by the app), `prompt` (string, max 100 chars; passed to Kling motion-control for context/environment)
