          ...
          <div className="flex items-center justify-between h-full">
            <div className="flex items-center gap-4 md:gap-6 h-full">
              ...
              <div className="flex items-center gap-3 md:gap-4 h-full">
                <Link href="/profile" className="opacity-60 hover:opacity-100 transition-opacity flex items-center h-full" aria-label="Profile">
                ...
                <Link href="/history" className="opacity-100 transition-opacity flex items-center h-full" aria-label="History">
