...
export default function PricingPage() {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      {/* Header */}
      <nav className="sticky top-0 z-50 backdrop-blur-xl bg-slate-950/95 border-b border-slate-800/50 h-12 sm:h-14 md:h-16">
        <div className="max-w-7xl mx-auto px-1.5 sm:px-3 md:px-4 lg:px-6 h-full">
          <div className="flex items-center justify-between h-full gap-0.5 sm:gap-1 md:gap-2">
            ...
            <div className="flex items-center gap-0.5 sm:gap-1 md:gap-1.5 lg:gap-2 flex-shrink-0">
              {!user && (
                <Link href="/#features" className="hidden sm:block text-[10px] md:text-xs lg:text-sm text-slate-400 hover:text-white transition-colors">
                  How it works
                </Link>
              )}
