...
function StudioPage() {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      {/* Navigation */}
      <nav className="sticky top-0 z-50 backdrop-blur-xl bg-slate-950/90 border-b border-slate-800/50 h-12 sm:h-14 md:h-16">
        <div className="max-w-7xl mx-auto px-1.5 sm:px-3 md:px-4 lg:px-6 h-full">
          <div className="flex items-center justify-between h-full gap-0.5 sm:gap-1 md:gap-2">
            <div className="flex items-center gap-1 sm:gap-1.5 md:gap-2 lg:gap-3 h-full flex-shrink-0">
              <div className="flex items-center">
                <Logo width={120} height={40} className="h-7 sm:h-9 md:h-12 lg:h-14 w-auto object-contain" />
              </div>
              <div className="flex items-center gap-0.5 sm:gap-1 md:gap-1.5 lg:gap-2">
                <Link href="/profile" className="opacity-60 hover:opacity-100 transition-opacity flex items-center" aria-label="Profile">
                  <img src="/icons/nav/profile.png" alt="" className="h-6 sm:h-8 md:h-10 lg:h-12 w-auto object-contain" />
                </Link>
                <Link href="/studio" className="opacity-100 transition-opacity flex items-center" aria-label="Studio">
                  <img src="/icons/nav/studio.png" alt="" className="h-6 sm:h-8 md:h-10 lg:h-12 w-auto object-contain" />
                </Link>
                <Link href="/history" className="opacity-60 hover:opacity-100 transition-opacity flex items-center" aria-label="History">
                  <img src="/icons/nav/history.png" alt="" className="h-6 sm:h-8 md:h-10 lg:h-12 w-auto object-contain" />
                </Link>
                <Link href="/pricing" className="opacity-60 hover:opacity-100 transition-opacity flex items-center" aria-label="Pricing">
                  <img src="/icons/nav/pricing.png" alt="" className="h-6 sm:h-8 md:h-10 lg:h-12 w-auto object-contain" />
                </Link>
              </div>
            </div>
            <div className="flex items-center gap-0.5 sm:gap-1 md:gap-1.5 lg:gap-2 flex-shrink-0">
              <div className="px-1 sm:px-1.5 md:px-2 lg:px-2.5 py-0.5 sm:py-1 md:py-1.5 bg-purple-600/20 border border-purple-500/30 rounded-md sm:rounded-lg flex items-center justify-center min-w-fit">
                <span className="text-[9px] sm:text-[10px] md:text-xs font-semibold text-purple-300 text-center whitespace-nowrap">{creditsRemaining} credits</span>
              </div>
              <button
                onClick={async () => { await signOut(); router.push('/'); }}
                className="flex items-center gap-0.5 sm:gap-1 md:gap-1.5 lg:gap-2 px-1 sm:px-1.5 md:px-2 py-0.5 sm:py-1 md:py-1.5 text-slate-400 hover:text-white hover:bg-slate-800/50 rounded-md sm:rounded-lg transition-colors flex-shrink-0"
                aria-label="Sign out"
              >
                ...
                <span className="hidden sm:inline text-[10px] md:text-xs lg:text-sm">Sign out</span>
              </button>
            </div>
          </div>
        </div>
