        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 h-full">
          <div className="flex items-center justify-between h-full gap-1 sm:gap-2">
            ...
            <div className="flex items-center gap-1 sm:gap-1.5 md:gap-2 flex-shrink-0">
              <div className="px-1.5 sm:px-2 md:px-2.5 py-1 sm:py-1.5 bg-purple-600/20 border border-purple-500/30 rounded-lg flex items-center justify-center min-w-fit">
                <span className="text-[10px] sm:text-xs font-semibold text-purple-300 text-center whitespace-nowrap">{creditsRemaining} credits</span>
              </div>
              <button
